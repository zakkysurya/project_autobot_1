         ...
         <div class="row">
             <div class="col-lg-3">
                 <div class="mt-5">
                     ...
                     <p class="fs-15 text-white-50 mt-4">A Private Limited is the most popular type of partnership
                         Malta.
                         The limited liability is, in fact, the only type of company allowed by Companies.</p>
         ...
         <div class="row justify-content-center">
             <div class="col-lg-6">
                 <p class="mb-0 text-center text-muted">©
                     ...
                     </script> Harold. Design with <i class="mdi mdi-heart text-danger"></i> by <a
                         href="https://themesdesign.in/" target="_blank" class="text-muted">Themesdesign.</a>
                 </p>
             </div>
         </div>
     </div>
 ...
 <!-- conter -->
 <script src="{{ asset('fe/js/counter.init.js') }}"></script>
