                                    ...
                                    <div class="top-bar p-4 pb-3">
                                        ...
                                        <div class="price-tag">
                                            <h2 class="text-dark mb-0 fs-40"><sup
                                                    class="fs-22 fw-semibold">$</sup>09<sup class="fs-16 fw-semibold">
                                                    /month</sup></h2>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="pricing-item active-border">
                                    <div class="top-bar p-4 pb-3">
                                        ...
                                        <div class="price-tag">
                                            <h2 class="text-dark mb-0 fs-40"><sup
                                                    class="fs-22 fw-semibold">$</sup>49<sup class="fs-16 fw-semibold">
                                                    /month</sup></h2>
                                        </div>
                                    </div>
                                    <div class="bottom-bar p-4 pt-3">
                            ...
                            <div class="col-lg-4">
                                <div class="pricing-item ">
                                    <div class="top-bar p-4 pb-3">
                                        ...
                                        <div class="price-tag">
                                            <h2 class="text-dark mb-0 fs-40"><sup
                                                    class="fs-22 fw-semibold">$</sup>99<sup class="fs-16 fw-semibold">
                                                    /month</sup></h2>
                                        </div>
                                    </div>
                                    <div class="bottom-bar p-4 pt-3">
                            ...
                            <div class="col-lg-4">
                                <div class="pricing-item  active-border">
                                    <div class="top-bar p-4 pb-3">
                                        ...
                                        <div class="price-tag">
                                            <h2 class="text-dark mb-0 fs-40"><sup
                                                    class="fs-22 fw-semibold">$</sup>199<sup class="fs-16 fw-semibold">
                                                    /Year</sup></h2>
                                        </div>
                                    </div>
                                    <div class="bottom-bar p-4 pt-3">
                            ...
                            <div class="col-lg-4">
                                <div class="pricing-item">
                                    <div class="top-bar p-4 pb-3">
                                        ...
                                        <div class="price-tag">
                                            <h2 class="text-dark mb-0 fs-40"><sup
                                                    class="fs-22 fw-semibold">$</sup>249<sup class="fs-16 fw-semibold">
                                                    /year</sup></h2>
                                        </div>
                                    </div>
                                    <div class="bottom-bar p-4 pt-3">
                            ...
                            <div class="col-lg-4">
                                <div class="pricing-item ">
                                    <div class="top-bar p-4 pb-3">
                                        ...
                                        <div class="price-tag">
                                            <h2 class="text-dark mb-0 fs-40"><sup
                                                    class="fs-22 fw-semibold">$</sup>299<sup class="fs-16 fw-semibold">
                                                    /year</sup></h2>
                                        </div>
                                    </div>
                                    <div class="bottom-bar p-4 pt-3">
            ...
            <div class="col-lg-4 mt-4 pt-2">
                <div class="blog-item p-4 box-shadow">
                    ...
                    <div class="blog-content mt-5">
                        ...
                        <a href="">
                            <h5>We makes UI/UX design very easy for you.</h5>
                        </a>
            ...
            <div class="col-lg-4 mt-4 pt-2">
                <div class="blog-item p-4 box-shadow">
                    ...
                    <div class="blog-content mt-5">
                        <!-- <p class="text-muted fw-semibold mb-2">May 25, 2021</p> -->
                        <a href="">
                            <h5>Current world design trends know easily.</h5>
                        </a>
                        <p class="fs-15 text-muted">He nicked it tickety boo harry the cras bargy chap mush spiffing
                            spend a penny.</p>
                        <a href="" class="text-dark fw-semibold">Learn more <i
            ...
            <div class="col-lg-4 mt-4 pt-2">
                <div class="blog-item p-4 box-shadow">
                    ...
                    <div class="blog-content mt-5">
                        <!-- <p class="text-muted fw-semibold mb-2">May 25, 2021</p> -->
                        <a href="">
                            <h5>We calculate clients demand for research.</h5>
                        </a>
                        <p class="fs-15 text-muted">He nicked it tickety boo harry the cras bargy chap mush spiffing
                            spend a penny.</p>
                        <a href="" class="text-dark fw-semibold">Learn more <i
